            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-sm-5">
                            <div class="background_bg h-100" data-img-src="<?= base_url() ?>/public/client/assets/images/logo-1.png"></div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-3">
                        <div class="categories_wrap">
                            ...
                            <div id="navCatContent" class="nav_cat navbar collapse">
                                <ul>
                                    <!-- <li><a class="dropdown-item nav-link nav_item" href="<?= base_url() ?>/loai-hang/ao"><i ></i> <span>Áo</span></a></li>
                                    <li><a class="dropdown-item nav-link nav_item" href="<?= base_url() ?>/loai-hang/quan-dai"><i></i> <span>Quần Dài</span></a></li>
                                    <li><a class="dropdown-item nav-link nav_item" href="<?= base_url() ?>/loai-hang/vay-dam"><i ></i> <span>Váy Đầm</span></a></li> -->
